        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Proteins = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    Carbo = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    Fat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Calories = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Recipe = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecipePhoto = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
